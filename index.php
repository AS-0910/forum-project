    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img\slider1.jpg" class="d-block w-100" width="100%" height="500px" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img\slider2.jpg" class="d-block w-100" width="100%" height="500px"alt="...">
            </div>
            <div class="carousel-item">
                <img src="img\slider3.png" class="d-block w-100" width="100%" height="500px"alt="...">
            </div>
        </div>
    ...
    <div class="container my-4">
        ...
        while($row=mysqli_fetch_assoc($result)){
            ...
            <div class="card " style="width: 18rem;">
                <img src="img\card'.$row['category_id'].'.png" class="card-img-top" width="200px" height="200px" alt="">
                <div class="card-body">
